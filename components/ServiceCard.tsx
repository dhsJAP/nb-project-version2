...
export function ServiceCard({
  ...
  return (
    <div
      ...
      className={`group relative bg-white border border-rose-100 rounded-2xl p-6 hover:border-rose-300 hover:shadow-lg hover:shadow-rose-100/50 hover:-translate-y-1 focus:outline-none focus:border-rose-300 focus:shadow-lg transition-all duration-300 ${ isDetailsOpen ? "z-[80]" : "z-10"}`}
    ...
    >
      ...
      {items.length > 0 && (
        <div
          className={`absolute left-4 right-4 z-[90] transition-all duration-200 ${
